...
| Rust/domínio | `docs/adr/0001-local-first.md`, `docs/adr/0004-document-ir-v1.md`, `docs/adr/0010-rust-core-ownership.md`, `crates/core/`, schemas espelho em `apps/web/src/schemas/` |
