...
| Ingestão/OCR/storage | `docs/INGESTION_OCR_ARCHITECTURE.md`, `docs/INGESTION_TEST_STRATEGY.md`, `docs/PERSISTENCE.md`, ADRs 0008–0009 e 0017, schemas e adapters relacionados |
