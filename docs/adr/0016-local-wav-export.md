...
- Cada nova gravação ganha chave imutável. O checkpoint atual referencia só a mais recente; gravações antigas permanecem acessíveis pelo catálogo. O usuário pode excluir uma gravação antiga com as salvaguardas do ADR 0017. Não há exclusão automática. Quota cheia mantém o WAV em memória para download, sem afirmar persistência.
