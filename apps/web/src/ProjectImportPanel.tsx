...
export function ProjectImportPanel({
  ...
  return <section className="panel import-panel" id="project" aria-labelledby="import-title">
    <div className="section-heading"><span className="section-number">01</span><div>
      <p className="section-kicker">PROJETO</p>
      <h2 id="import-title">{hasDocument ? "Documento importado" : "Comece com um PDF"}</h2>
    </div></div>
